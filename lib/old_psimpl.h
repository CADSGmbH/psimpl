...
namespace psimpl
{
    ...
    */
    namespace math
    {
        ...
        {
            // ---------- equal --------------------------------------------------------------------
            template <unsigned DIM, class InputIterator, class iterator_category>
            struct equal
            {
                static bool apply (InputIterator p1, InputIterator p2)
                {
            ...
            struct equal <DIM, InputIterator, std::random_access_iterator_tag>
            {
                static bool apply (InputIterator p1, InputIterator p2)
                {
                    return
                        equal <DIM-1, InputIterator, std::random_access_iterator_tag>::apply (p1, p2) &&
                        p1 [DIM-1] == p2 [DIM-1];
                }
            };

            template <class InputIterator>
            struct equal <1, InputIterator, std::random_access_iterator_tag>
            {
                static bool apply (InputIterator p1, InputIterator p2)
                {
                    return p1 [0] == p2 [0];
            ...
            // ---------- make_vector --------------------------------------------------------------
            template <unsigned DIM, class InputIterator, class RandomAccessIterator, class iterator_category>
            struct make_vector
            {
                static void apply (InputIterator p1, InputIterator p2, RandomAccessIterator result)
                {
                    for (unsigned d = 0; d < DIM; ++d, ++p1, ++p2) {
                        result [d] = *p2 - *p1;
                    }
            ...
            template <unsigned DIM, class InputIterator, class RandomAccessIterator>
            struct make_vector <DIM, InputIterator, RandomAccessIterator, std::random_access_iterator_tag>
            {
                static void apply (InputIterator p1, InputIterator p2, RandomAccessIterator result)
                {
                    make_vector <DIM-1, InputIterator, RandomAccessIterator, std::random_access_iterator_tag>::apply (p1, p2, result);
                    result [DIM-1] = p2 [DIM-1] - p1 [DIM-1];
                }
            };

            template <class InputIterator, class RandomAccessIterator>
            struct make_vector <1, InputIterator, RandomAccessIterator, std::random_access_iterator_tag>
            {
                static void apply (InputIterator p1, InputIterator p2, RandomAccessIterator result)
                {
                    result [0] = p2 [0] - p1 [0];
            ...
            struct dot
            {
                ...
                static value_type apply (InputIterator v1, InputIterator v2)
                {
                    value_type result = 0;
            ...
            template <unsigned DIM, class InputIterator>
            struct dot <DIM, InputIterator, std::random_access_iterator_tag>
            {
                typedef typename std::iterator_traits <InputIterator>::value_type value_type;
                ...
                {
                    return
                        dot <DIM-1, InputIterator, std::random_access_iterator_tag>::apply (v1, v2) +
                        v1 [DIM-1] * v2 [DIM-1];
                }
            };

            template <class InputIterator>
            struct dot <1, InputIterator, std::random_access_iterator_tag>
            {
                typedef typename std::iterator_traits <InputIterator>::value_type value_type;
            ...
            // ---------- point_distance2 ----------------------------------------------------------
            template <unsigned DIM, class InputIterator1, class InputIterator2, class iterator_category>
            struct point_distance2
            {
                typedef typename std::iterator_traits <InputIterator1>::value_type value_type;

                static value_type apply (InputIterator1 p1, InputIterator2 p2)
                {
                    value_type result = 0;
                    for (unsigned d = 0; d < DIM; ++d, ++p1, ++p2) {
                        result += (*p1 - *p2) * (*p1 - *p2);
            ...
            struct point_distance2 <DIM, InputIterator1, InputIterator2, std::random_access_iterator_tag>
            {
                typedef typename std::iterator_traits <InputIterator1>::value_type value_type;
                ...
                {
                    return
                        point_distance2 <DIM-1, InputIterator1, InputIterator2, std::random_access_iterator_tag>::apply (p1, p2) +
                        (p1 [DIM-1] - p2 [DIM-1]) * (p1 [DIM-1] - p2 [DIM-1]);
                }
            };

            template <class InputIterator1, class InputIterator2>
            struct point_distance2 <1, InputIterator1, InputIterator2, std::random_access_iterator_tag>
            {
                typedef typename std::iterator_traits <InputIterator1>::value_type value_type;
        ...
        */
            ...
            InputIterator p2)
        {
            ...
            return detail::equal <DIM, InputIterator, iterator_category>::apply (p1, p2);
        }
        ...
        */
        template <unsigned DIM, class InputIterator, class RandomAccessIterator>
        inline void make_vector (
            InputIterator p1,
            InputIterator p2,
            RandomAccessIterator result)
        {
            typedef typename std::iterator_traits <InputIterator>::iterator_category iterator_category;
            detail::make_vector <DIM, InputIterator, RandomAccessIterator, iterator_category>::apply (p1, p2, result);
        }
        ...
        */
        ...
        {
            typedef typename std::iterator_traits <InputIterator>::iterator_category iterator_category;
            return detail::dot <DIM, InputIterator, iterator_category>::apply (v1, v2);
        }
        ...
        */
        ...
        inline typename std::iterator_traits <InputIterator1>::value_type point_distance2 (
            ...
            InputIterator2 p2)
        {
            typedef typename std::iterator_traits <InputIterator1>::iterator_category iterator_category;
            return detail::point_distance2 <DIM, InputIterator1, InputIterator2, iterator_category>::apply (p1, p2);
        }
